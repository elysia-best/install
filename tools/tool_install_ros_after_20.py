"""
This tool install ROS1 on systems after Ubuntu 20.04
...
class Tool(BaseTool):
    def __init__(self):
        self.name = "一键在Ubuntu22.04和24.04安装ROS1，目前仅支持AMD64"
    ...
    def add_key(self):
        ...
        if osversion.get_codename() == 'jammy':
            pass
        elif osversion.get_codename() == 'noble':
            pass
